...
registerProviderFileTransformer('diagnostic-source', 'replace', {
...
registerProviderHostContract('ordered-mount-provider', {
  projectDocument: provided({
    ...
    sourceProtection: waived('test fixture'),
  }),
  stateVolumes: [
    {
      id: 'ordered-state',
  ...
  skillBackings: [
    {
      ...
      sharedLinks: waived('test fixture'),
      conflictDiagnostics: provided('silent'),
      templateCopies: waived('test fixture'),
    },
  ],
  skillViews: [
    {
...
describe('ordered provider spawn operations', () => {
      ...
      skillBackings: [
        {
          ...
          skillsSubdirectory: 'skills',
          sharedLinks: waived('test fixture'),
          conflictDiagnostics: waived('test fixture'),
          templateCopies: waived('test fixture'),
        },
      ],
      skillViews: [],
  ...
  it.each([
    ...
    const contract = backingContract({
      ...
      conflictDiagnostics: provided(policy),
      templateCopies: waived('test fixture'),
    });
